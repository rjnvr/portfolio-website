...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className="home__title">Arjunvir Sidhu
          <svg
                width="36"
                height="36"
                viewBox="0 0 48 48"
        ...
        <p className="home__description">I am a computer science student with an interest in Data, Financial Markets (trading) & Technology</p>
