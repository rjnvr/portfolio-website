...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_eo35oqi', 'template_mzmax1n', form.current, 'cv5LXP8C8KITT_2cg')
    e.target.reset();
  };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">sidhuarjunvir@gmail.com</span>

                        <a href="mailto:sidhuarjunvir@gmail.com" className="contact__button">Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
